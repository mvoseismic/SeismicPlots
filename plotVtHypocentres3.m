...
symbolFill = inputd( 'Symbol fill( y/n )', 's', 'n' );
...
switch symbolType
    case 'f'
        switch symbolFill
            case 'y'
                plot( ax1, hypoX, hypoY, 'ro', 'MarkerSize', 4,'MarkerFaceColor', 'r' );
            otherwise
    ...
    case 'm'
        switch symbolFill
            case 'y'
                scatter( ax1, hypoX, hypoY, 2*hypoMss, 'r', 'MarkerFaceColor', 'r' );
            otherwise
...
switch symbolType
    case 'f'
        switch symbolFill
            case 'y'
                plot( ax3, hypoX, hypoZ, 'ro', 'MarkerSize', 4,'MarkerFaceColor', 'r' );
            otherwise
    ...
    case 'm'
        switch symbolFill
            case 'y'
                scatter( ax3, hypoX, hypoZ, 2*hypoMss, 'r', 'MarkerFaceColor', 'r' );
            otherwise
                scatter( ax3, hypoX, hypoZ, 2*hypoMss, 'r' );
        end
end
hold on;
...
switch symbolType
    case 'f'
        switch symbolFill
            case 'y'
                plot( ax4, hypoY, hypoZ, 'ro', 'MarkerSize', 4,'MarkerFaceColor', 'r' );
            otherwise
    ...
    case 'm'
        switch symbolFill
            case 'y'
                scatter( ax4, hypoY, hypoZ, 2*hypoMss, 'r', 'MarkerFaceColor', 'r' );
            otherwise
                scatter( ax4, hypoY, hypoZ, 2*hypoMss, 'r' );
        end
end
hold on;
...
switch symbolType
    case 'f'
        switch symbolFill
            case 'y'
                plot( ax5, hypoOtime, hypoZ, 'ro', 'MarkerSize', 4, 'MarkerFaceColor', 'r' );
            otherwise
    ...
    case 'm'
        switch symbolFill
            case 'y'
                scatter( ax5, hypoOtime, hypoZ, hypoMss, 'r', 'MarkerFaceColor', 'r' );
            otherwise
